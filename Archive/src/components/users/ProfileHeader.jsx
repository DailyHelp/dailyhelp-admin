  ...
  return (
    <div className="flex justify-between p-4">
      <div className="bg-white   flex items-center">
        <div>
          <usersData.avatar className="rounded-full" />
        </div>
      ...
      <div className="flex items-center gap-4">
        <button
          className="flex gap-1 items-center text-[#017441] font-bold text-sm"
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-white font-semibold transition 
              ${
                status === 'Suspended'
                  ? 'bg-[#017441] hover:bg-green-900' // ✅ Reactivate → Green
                  : 'bg-[#F0443A] hover:bg-red-600' // ✅ Suspend → Red
              }`}
        >
