...
// Normalized, consistent schema for team members
// Note: `emailaddress` duplicates `email` to match current table header key
// in `src/components/team-members/JobsTable.jsx`.

export const TEAM_ROLES = ['Super Admin', 'Admin', 'Customer service'];
