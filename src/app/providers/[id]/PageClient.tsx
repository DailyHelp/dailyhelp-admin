...
import type { JobItem, SortConfig, JobSortKey, ProviderProfile } from '@/types/types';
...
export default function ProvidersProfilePage({ id }: { id: string }) {
  ...
  const [selectedUsers, setSelectedUsers] = useState<ProviderProfile | false>(false);
  ...
  const handleSuspendClick = (user: ProviderProfile) => {
  ...
  return (
    <div className="py-6 space-y-4">
      ...
      {activeTab === 'analytics' && <Analytics analytics={user.analytics!} />}
