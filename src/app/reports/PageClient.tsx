...
export default function ReportsPage() {
  ...
  const jobsData = useMemo<JobItem[]>(() => reportsDataDetails ?? [], []);
    ...
    return [...filteredJobs].sort((a, b) => {
      ...
      switch (key) {
        case 'jobId':
          ...
          break;
        case 'client':
          result = cmp((a as any).reporter?.name, (b as any).reporter?.name);
          break;
        case 'serviceProvider':
          result = cmp((a as any).reportedParty?.name, (b as any).reportedParty?.name);
          break;
        case 'amount':
        ...
        case 'status':
          ...
          break;
        case 'reason':
          result = cmp((a as any).reason, (b as any).reason);
          break;
      }
