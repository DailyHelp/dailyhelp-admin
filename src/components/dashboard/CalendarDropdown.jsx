...
export default function CalendarDropdown({ onDateChange }) {
            ...
            {presetOptions.map((option) => (
              <button
                ...
                className={`text-left text-md px-2 py-1 rounded cursor-pointer ${
                  selected === option.label ? 'bg-[#E6FFF4] text-[#121921] font-semibold' : 'hover:bg-[#E6FFF4]'
                }`}
              >
                {option.label}
              </button>
            ...
            <div className="p-2 ">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <button onClick={handlePrevMonth} className="p-2 border border-[#D6DBE7] rounded-xl cursor-pointer">
                      <LeftArrow className="w-4 h-4 text-gray-600" />
                    </button>
                    <button onClick={handleNextMonth} className="p-2 border border-[#D6DBE7] rounded-xl cursor-pointer">
             ...
             <div className="flex justify-between items-center px-3 py-[12px]">
              ...
              <div className="space-x-2">
                <button
                  ...
                  className="px-[6px] py-1 border border-[#D6DBE7] rounded-xl font-semibold text-xs text-[#017441] cursor-pointer"
                >
                  Cancel
                </button>
                <button
