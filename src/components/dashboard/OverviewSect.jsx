        ...
        <div>
            <section className='grid grid-cols-2 gap-4'>
                <div className="bg-[#F9F9FB] rounded-xl border border-[#F1F2F4]">
                    <h2 className="text-[14px] text-[#757C91] font-semibold border-b border-[#F1F2F4] px-4 py-2">Revenue</h2>
                ...
                <div className="bg-[#F9F9FB] rounded-xl border border-[#F1F2F4]">
                    <h2 className="text-[14px] text-[#757C91] font-semibold border-b border-[#F1F2F4] px-4 py-2">User Growth</h2>
