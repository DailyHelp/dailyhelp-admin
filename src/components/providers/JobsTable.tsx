...
export type ProvidersJobsTableSortConfig = SortConfig<JobSortKey>;

export interface ProvidersJobsTableProps {
  jobs: JobItem[];
  onSortChange: (cfg: ProvidersJobsTableSortConfig) => void;
  sortConfig: ProvidersJobsTableSortConfig;
...
export default function JobsUsersTable({
  ...
  return (
    <div className="mx-6 overflow-x-auto">
      <table className="w-full min-w-[720px] text-left border-collapse" role="table" aria-label="Provider jobs table">
