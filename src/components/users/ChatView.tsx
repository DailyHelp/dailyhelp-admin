...
import type { ChatThread, JobItem, UserProfile } from '@/types/types';
                          ...
                          {isCountered ? (
                            ...
                            <div>
                              ...
                              <div className="flex justify-between items-center mt-3 gap-2">
                                <Button
                                  variant="secondary"
                                  className="!bg-transparent border border-[#D6DBE7] text-red-500 !px-10 !py-2 text-xs"
                                >
                                  Decline
                                </Button>
                                <Button className="!bg-[#C1FF1D] text-[#121921] !px-7 !py-2 text-xs">
                                  Accept & Pay
                                </Button>
                              </div>
                            </div>
