...
export interface JobsStatusBadgeProps {
  status?: 'Pending' | 'InProgress' | 'Canceled' | 'Disputed' | 'Completed' | string;
}

export default function JobsStatusBadge({ status = 'Pending' }: JobsStatusBadgeProps) {
  return (
    <span className={`w-fit relative text-xs rounded-sm font-bold flex px-2 py-1 pl-6 items-center ${
