...
export const ratingsData: RatingItem[] = [
...
export const revenueData: SeriesItem[] = [
  { name: 'JAN', value: 11.5 },
  { name: 'FEB', value: 9 },
  { name: 'MAR', value: 4 },
  { name: 'APR', value: 7.5 },
...
export const userGrowthData: SeriesItem[] = [
  { name: 'JAN', value: 11.5 },
  { name: 'FEB', value: 9 },
  { name: 'MAR', value: 4 },
  { name: 'APR', value: 7.5 },
...
export const topServicesData: CategoryAmountItem[] = [
...
export const topLocationData: CategoryAmountItem[] = [
...
export const CategoryProviders: CategoryAmountItem[] = [
